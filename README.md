...
indispensable para aquello que debemos apuntar en el día con día, por ello nace MyNotes, para ofrecerte de manera digital lo que solemos escribir en los postit.

En este proyecto  trabaje con la libreria de React para su implementación y la API de firebase. 
Funcionalidades básicas:

* Autenticación con correo y/o Google.
* Cerrar sesión.
...
link: https://www.figma.com/file/rMO5JhQXDW5cvN6SOe6Med/Proyecto---Lab-Notes?node-id=0%3A1

## 5. Acceso a MyNOtes.

link: https://labnotesreact.web.app/  Usuario de prueba: usuario@prueba.com Contraseña: 123456.
